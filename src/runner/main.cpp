...
int main(int argc, char * argv[])
{
  ...
  std::unordered_map<std::string, std::function<std::shared_ptr<rclcpp_lifecycle::LifecycleNode>()>> attack_node_list = {
  ...
  std::shared_ptr<std::vector<std::string>> initialized_nodes = std::make_shared<std::vector<std::string>>();
  //Intialize nodes
