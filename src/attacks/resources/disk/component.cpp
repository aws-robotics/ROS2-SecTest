...
Component::Component() : rclcpp_lifecycle::LifecycleNode("disk_attacker", "", true) {}
...
CLASS_LOADER_REGISTER_CLASS(ros_sec_test::attacks::resources::disk::Component, rclcpp_lifecycle::LifecycleNode)